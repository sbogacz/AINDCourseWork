...
class TestUnits(unittest.TestCase):
    # first populate the "globals" in solution
    def testBoxOnDiagonal(self):
        self.assertEqual(len(solution.units["A1"]), 4, "units on diagonals should have 4 units they belong to")
        self.assertEqual(len(solution.units["C3"]), 4, "units on diagonals should have 4 units they belong to")
    def testBoxOffDiagonal(self):
        self.assertEqual(len(solution.units["A2"]), 3, "units off diagonals should have 3 units they belong to")
        self.assertEqual(len(solution.units["F3"]), 3, "units off diagonals should have 3 units they belong to")
...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    diagonal_grid_2 = '..............1.....6...4.....1.....15..7.3...8...5..2....872.......6943.....4..8'
    diagonal_grid_3 = '953..7......9................8.......17...............34.8..529..5.....3.....5...'
    diagonal_grid_4 = '......8.68.........7..863.....8............8..8.5.9...1.8..............8.....8.4.'
    ...
    def test_solve_2(self):
        self.assertTrue(solution.is_valid_sudoku(solution.solve(self.diagonal_grid_2), True))
    def test_solve_3(self):
        self.assertTrue(solution.is_valid_sudoku(solution.solve(self.diagonal_grid_3), True))
    def test_solve_4(self):
        self.assertTrue(solution.is_valid_sudoku(solution.solve(self.diagonal_grid_4), True))
